...
**Active branch:** `feat/m4-sce-relocation-batch-plan-v2`
...
2. The planner preserves table kind/raw relocation evidence and remains semantics-free; the PLT entry point stays as a compatibility wrapper.
